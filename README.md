# Data dictionary 
- symbol: stocksTicker's symbol
- date: date for the start of the aggregate window
...
- volume_average: The volume weighted average price.
- number_of_transactions: The number of transactions in the aggregate window.
